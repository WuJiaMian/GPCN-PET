...
class MRI_SwinMR_NPI(ModelBase):
    ...
    def feed_data(self, data, need_H=True):
        ...
        self.prompt_manu = data['prompt_manu']
        self.prompt_vec = data['prompt_vec']
        self.prompt_tracer = data['prompt_tracer']



    def netG_forward(self):
        self.E = self.netG(self.L,self.prompt_manu,self.prompt_tracer,self.prompt_vec)
