...
class WindowAttention(nn.Module):
    ...
    def __init__(self, qkv1,qkv2,qkv3,dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
    ...
    def forward(self, x, mask=None):
        ...
        qkv1 = self.qkv1(x).reshape(B_, N, 1, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
        qkv2 = self.qkv2(x).reshape(B_, N, 1, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
        qkv3 = self.qkv3(x).reshape(B_, N, 1, self.num_heads, C // self.num_heads).permute(2, 0, 3, 1, 4)
        q, k, v = qkv1[0], qkv2[0], qkv3[0]  # make torchscript happy (cannot use tensor as tuple)
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, qkv1,qkv2,qkv3,dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.attn = WindowAttention(qkv1,qkv2,qkv3,
    ...
    def forward(self, x, x_size):
        ...
        if self.input_resolution == x_size:
            attn_windows = self.attn(x_windows, mask=self.attn_mask)  # nW*B, window_size*window_size, C  1600 64 180
        else:
...
class BasicLayer(nn.Module):
    ...
    def __init__(self,qkv1,qkv2,qkv3, dim, input_resolution, depth, num_heads, window_size,
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(qkv1,qkv2,qkv3,dim=dim, input_resolution=input_resolution,
...
class RSTB(nn.Module):
    ...
    def __init__(self, qkv1,qkv2,qkv3,dim, input_resolution, depth, num_heads, window_size,
        ...
        self.residual_group = BasicLayer(qkv1,qkv2,qkv3,dim=dim,
...
class WTConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size=5, stride=1, bias=True, wt_levels=1, wt_type='db1'):
        ...
        self.layer = RSTB(self.shared_qkv1, self.shared_qkv2, self.shared_qkv3, dim=embed_dim,
